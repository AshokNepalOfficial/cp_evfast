        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.label}>
                  <Link
                    href={item.href}
                    className="text-white/50 hover:text-emerald-500 text-sm transition-colors"
                  >
                    {item.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ...
                <li key={item.label}>
                  <Link href={item.href} className="text-white/50 hover:text-emerald-500 text-sm transition-colors">
                    {item.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <a href="tel:+977 9851315997" className="flex items-center gap-3 text-sm text-white/50 hover:text-emerald-500 transition-colors">
              ...
              <li>
                <a href="tel:+977 9843176778" className="flex items-center gap-3 text-sm text-white/50 hover:text-emerald-500 transition-colors">
                  <Phone size={16} className="text-emerald-500" />
                  +977 9843176778
                </a>
              </li>
              ...
              <li>
                <a href="mailto:evfast2024@gmail.com" className="flex items-center gap-3 text-sm text-white/50 hover:text-emerald-500 transition-colors">
