...
export default function NewsPage() {
  ...
  return (
    <>
      <Head>
        <title>EV Charging News | Industry Updates & Company Announcements</title>
        <meta name="description" content="Stay informed with the latest EV industry news, charging infrastructure trends, and EV Fast Charging company announcements." />
        <meta name="keywords" content="EV news, charging infrastructure, OCPP 2.0.1, ultra-fast DC charger, EV industry, EV Fast Charging" />
        <meta property="og:title" content="EV Charging News | EV Fast Charging" />
        <meta property="og:description" content="Latest news on EV charging infrastructure, industry standards, and company updates from EV Fast Charging." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="EV Charging News | EV Fast Charging" />
        <meta name="twitter:description" content="Stay up to date with EV industry news and company announcements." />
      </Head>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-4 mb-10 border-b border-gray-100 pb-4 overflow-x-auto">
            <Link href="/news" className="text-emerald-600 font-semibold text-sm border-b-2 border-emerald-600 pb-4 -mb-4">
              All News
            </Link>
          ...
          <div className="grid md:grid-cols-2 gap-8 pb-16">
            {newsItems.map((item, index) => {
              ...
              const categoryIcon = item.category === 'Industry Information' ? '📊' : '⚡';
              const categoryLabel = item.category === 'Industry Information' ? 'Industry' : 'Company';
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <p className="text-gray-600 text-sm mb-6 flex-grow">
                      {isOpen ? item.desc : item.desc.slice(0, 90) + '...'}
                    </p>
                    {/* BUTTON */}
                    <button
