...
export default function EVGroupNewsPage() {
  ...
  return (
    <>
      <Head>
        <title>EV Group News | EV Fast Charging</title>
        <meta name="description" content="Latest news and announcements from EV Fast Charging – product launches, global expansion, and industry events." />
        <meta name="keywords" content="EV news, charging infrastructure, EV Fast Charging, ultra-fast DC charger, renewable energy, EV group" />
        <meta property="og:title" content="EV Group News | EV Fast Charging" />
        <meta property="og:description" content="Stay updated with the latest developments from EV Fast Charging – new products, certifications, and global partnerships." />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="EV Group News | EV Fast Charging" />
        <meta name="twitter:description" content="Latest news from EV Fast Charging – product launches, global expansion, and industry insights." />
      </Head>
      ...
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-4 mb-10 border-b border-gray-100 pb-4 overflow-x-auto">
            ...
            <Link href="/news/Ev-group-news" className="text-emerald-600 font-semibold text-sm border-b-2 border-emerald-600 pb-4 -mb-4">
              EV Group News
            </Link>
          </div>
