export default function PrivacyPage() {
  return (
    <>
      <section className="relative pt-32 pb-16 bg-gradient-to-r from-emerald-600 to-green-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-white text-5xl font-bold" style={{ fontFamily: 'Syne, sans-serif' }}>
            Privacy Policy
          </h1>
        </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray">
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <a href="mailto:info@woluncharging.com" className="text-emerald-600 hover:text-emerald-700 transition-colors">
              info@woluncharging.com
            </a>.
          </p>
        </div>
      </section>
