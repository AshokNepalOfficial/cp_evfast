        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {sortedProducts.map((product, index) => (
            <Link
              key={product.id}
              href={product.link}
              className="group bg-white rounded-lg overflow-hidden border border-slate-200 hover:border-emerald-400 shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2"
              style={{
            ...
            >
              ...
              {/* Product Info */}
              <div className="p-6">
                <h3 className="text-lg font-bold text-slate-900 line-clamp-2 group-hover:text-emerald-600 transition-colors mb-3">
                  {product.title}
                </h3>
                ...
                {/* Action */}
                <div className="flex items-center text-emerald-600 font-medium text-sm group-hover:gap-2 transition-all duration-300">
